...
`,
	...
	`a translator's note with no content should result in the element being removed and no translator note present`: {
	...
	`a translator's note with no content in parentheses should result in the element being removed and no translator note present`: {
		inputText:      `<p>(TL Note: )</p>`,
		fileName:       "main.xhtml",
		noteFileName:   "notes.xhtml",
		startingNumber: 0,
	...
	`a translator's note with no content in square brackets should result in the element being removed and no translator note present`: {
		inputText:      `<p>[TL Note: ]</p>`,
		fileName:       "main.xhtml",
		noteFileName:   "notes.xhtml",
		startingNumber: 0,
	...
	`a translator's note with no content in an element with other content should result in the note being removed and no translator note present`: {
		inputText:      `<p>Some content. TL Note:</p>`,
		fileName:       "main.xhtml",
		noteFileName:   "notes.xhtml",
		startingNumber: 0,
		expectedText:   "<p>Some content. </p>",
		expectedNotes:  []string{},
		expectedNext:   0,
	},
	`a translator's note with no content in parentheses in an element with other content should result in the note being removed and no translator note present`: {
		inputText:      `<p>Some content. (TL Note:)</p>`,
		fileName:       "main.xhtml",
		noteFileName:   "notes.xhtml",
		startingNumber: 0,
	...
	`a translator's note with no content in square brackets an element with other content should result in the note being removed and no translator note present`: {
		inputText:      `<p>Some content.[TL Note:]</p>`,
		fileName:       "main.xhtml",
		noteFileName:   "notes.xhtml",
		startingNumber: 0,
