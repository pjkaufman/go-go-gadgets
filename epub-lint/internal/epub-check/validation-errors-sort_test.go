		...
		input: ValidationErrors{
			ValidationIssues: []ValidationError{
				...
				},
				{
					Code:     "RSC-002",
					FilePath: "chapter1.html",
					Location: &Position{Line: 3, Column: 5},
					Message:  emptyMetadataProperty + "publisher\" invalid",
				},
				{
					Code:     "RSC-005",
			...
			ValidationIssues: []ValidationError{
				{
					...
					Location: &Position{Line: 7, Column: 25},
					Message:  "Some error",
				},
				{
					Code:     "RSC-005",
					FilePath: "zing.html",
					Location: &Position{Line: 529, Column: 7},
					Message:  "Some error",
				},
				{
					Code:     "RSC-005",
		...
		input: ValidationErrors{
			ValidationIssues: []ValidationError{
				...
				},
				{
					Code:     "OPF-014",
					FilePath: "content.opf",
					Location: &Position{Line: 16, Column: 15},
					Message:  "Some error",
				},
			},
		},
		...
		input: ValidationErrors{
			ValidationIssues: []ValidationError{
				...
				},
				{
					Code:     "RSC-005",
					FilePath: "alpha.html",
					Location: &Position{Line: 7, Column: 578},
					Message:  "Some error",
				},
				{
					Code:     "RSC-005",
					FilePath: "alpha.html",
					Location: &Position{Line: 7, Column: 7},
					Message:  "Some error",
				},
			},
		},
		...
		input: ValidationErrors{
			ValidationIssues: []ValidationError{
				...
				},
				{
					Code:     "RSC-005",
					FilePath: "new.html",
					Location: &Position{Line: 18, Column: 10},
					Message:  "Some error",
				},
				{
					Code:     "RSC-005",
					FilePath: "new.html",
					Location: &Position{Line: 18, Column: 20},
					Message:  "Some error",
				},
				{
					Code:     "RSC-005",
					FilePath: "new.html",
					Location: &Position{Line: 5, Column: 2},
					Message:  "Some error",
				},
			},
		},
